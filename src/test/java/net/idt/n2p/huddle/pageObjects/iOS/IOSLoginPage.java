...
public class IOSLoginPage extends BasePage implements ILoginPage {
    ...
    @iOSXCUITFindBy(xpath = "//android.widget.EditText[@resource-id='email']")
    public MobileElement loginName;

    @iOSXCUITFindBy(xpath = "//android.widget.Button[@text='NEXT']")
    public MobileElement nextLoginButton;

    @iOSXCUITFindBy(xpath = "//android.widget.EditText[@resource-id='password']")
